    ...
    <div class="flex w-full justify-between pr-20 lg:pr-40">
      <div class="flex flex-col gap-4">
        ...
        >
          ...
          <!--plus icon-->
          <svg
              class="text-info bottom-[10%] right-0 absolute w-6 h-6 lg:w-12 lg:h-12 translate-x-1/2 cursor-pointer"
              fill="currentColor"
              viewBox="0 0 16 16"
              xmlns="http://www.w3.org/2000/svg"
          >
            <path
                d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0
